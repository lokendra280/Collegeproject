      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade">
            ...
            <p>Kath-city cargo is a logistics provider in Nepal. We are one of the best dependable logistics
              service in Nepal. We provide customized logistics solutions to the corporates/business housesand personal parcel on the basis of their needs.</p>
            <p class="mb-5">We guarantee on providing on time delivery commitments and real time tracking of the goods facilities.!</p>
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                <div class="unit-4">
                  ...
                  <div>
                    <h3>Air Freight</h3>
                    <p>Air export is the best way to send your goods and products from one place to another in a fast
                      manner.</p>
                    <p class="mb-0"><a href="#">Learn More</a></p>
                  </div>
                </div>
